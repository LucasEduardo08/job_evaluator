...
urlpatterns = [
    ...
    path("teste-protegido/", TesteProtegidoView.as_view(), name="teste_protegido"),
    path("me/", MeView.as_view(), name="me"),

    path("criar_usuario/", cadastrar_usuario, name="criar_usuario"),
    path("usuario/me/", obter_usuario, name="usuario_me"),
    path("usuario/editar/me/", editar_usuario, name="editar_usuario"),
    path("usuario/deletar/me/", deletar_usuario, name="deletar_usuario"),
    ...
    path("curriculo/me/", obter_curriculos, name="curriculos"),
    path("curriculo/<int:id>/", obter_curriculo, name="curriculo_especifico"),
    path("curriculo/editar/<int:id>/", editar_curriculo, name="editar_curriculo"),
    path("curriculo/deletar/<int:id>/", deletar_curriculo, name="deletar_curriculo"),
]